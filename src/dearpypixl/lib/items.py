...
mvActivatedHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvActiveHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvAnnotation.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot,)  # type: ignore
mvAreaSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvAxisTag.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvBarGroupSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvBarSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvBoolValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvButton.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvCandleSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvCharRemap.__item_parents__ = (mvFont, mvTemplateRegistry,)  # type: ignore
mvCheckbox.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvChildWindow.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvClickedHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvClipper.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvCollapsingHeader.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorButton.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorEdit.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorMap.__item_parents__ = (mvColorMapRegistry, mvTemplateRegistry,)  # type: ignore
mvColorMapButton.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorMapScale.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorMapSlider.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorPicker.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvColorValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvCombo.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvCustomSeries.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDatePicker.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDeactivatedAfterEditHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvDeactivatedHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvDigitalSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvDouble4Value.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvDoubleClickedHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvDoubleValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvDragDouble.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragDoubleMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragFloat.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragFloatMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragInt.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragIntMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDragLine.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot,)  # type: ignore
mvDragPayload.__item_parents__ = (mvButton, mvCheckbox, mvCombo, mvDragIntMulti, mvDragFloatMulti, mvDragDoubleMulti, mvDragInt, mvDragFloat, mvDragDouble, mvImage, mvImageButton, mvInputIntMulti, mvInputFloatMulti, mvInputDoubleMulti, mvInputInt, mvInputFloat, mvInputDouble, mvInputText, mvListbox, mvMenuItem, mvRadioButton, mvSelectable, mvSliderIntMulti, mvSliderFloatMulti, mvSliderDoubleMulti, mvSliderInt, mvSliderFloat, mvSliderDouble, mvTabButton, mvText, mvColorButton, mvColorEdit, mvColorMapButton, mvColorPicker, mvCollapsingHeader, mvGroup, mvTreeNode, mvDatePicker, mvKnobFloat, mvLoadingIndicator, mvSlider3D, mvTimePicker, mvProgressBar, mvNode, mvPlot,)  # type: ignore
mvDragPoint.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot,)  # type: ignore
mvDragRect.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot,)  # type: ignore
mvDrawArrow.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawBezierCubic.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawBezierQuadratic.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawCircle.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawEllipse.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawImage.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawImageQuad.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawLayer.__item_parents__ = (mvTemplateRegistry, mvStage, mvDrawlist, mvWindowAppItem, mvPlot, mvViewportDrawlist,)  # type: ignore
mvDrawLine.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawNode.__item_parents__ = (mvTemplateRegistry, mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvViewportDrawlist, mvDrawNode,)  # type: ignore
mvDrawPolygon.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawPolyline.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawQuad.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawRect.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawText.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawTriangle.__item_parents__ = (mvStage, mvDrawlist, mvDrawLayer, mvWindowAppItem, mvPlot, mvDrawNode, mvViewportDrawlist, mvTemplateRegistry, mvCustomSeries,)  # type: ignore
mvDrawlist.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvDynamicTexture.__item_parents__ = (mvStage, mvTemplateRegistry, mvTextureRegistry,)  # type: ignore
mvEditedHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvErrorSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvFileExtension.__item_parents__ = (mvStage, mvFileDialog, mvTemplateRegistry,)  # type: ignore
mvFilterSet.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvFloat4Value.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvFloatValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvFloatVectValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvFocusHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvFont.__item_parents__ = (mvFontRegistry,)  # type: ignore
mvFontChars.__item_parents__ = (mvFont, mvTemplateRegistry,)  # type: ignore
mvFontRange.__item_parents__ = (mvFont, mvTemplateRegistry,)  # type: ignore
mvFontRangeHint.__item_parents__ = (mvFont, mvTemplateRegistry,)  # type: ignore
mvGroup.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvHeatSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvHistogramSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvHoverHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvImage.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvImageButton.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvImageSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvInfLineSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvInputDouble.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputDoubleMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputFloat.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputFloatMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputInt.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputIntMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInputText.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvInt4Value.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvIntValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvKeyDownHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvKeyPressHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvKeyReleaseHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvKnobFloat.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvLabelSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvLineSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvListbox.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvLoadingIndicator.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvMenu.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvMenuBar.__item_parents__ = (mvWindowAppItem, mvChildWindow, mvNodeEditor, mvStage, mvTemplateRegistry,)  # type: ignore
mvMenuItem.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvMouseClickHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseDoubleClickHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseDownHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseDragHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseMoveHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseReleaseHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvMouseWheelHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvHandlerRegistry,)  # type: ignore
mvNode.__item_parents__ = (mvTemplateRegistry, mvStage, mvNodeEditor,)  # type: ignore
mvNodeAttribute.__item_parents__ = (mvTemplateRegistry, mvStage, mvNode,)  # type: ignore
mvNodeEditor.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvNodeLink.__item_parents__ = (mvTemplateRegistry, mvStage, mvNodeEditor,)  # type: ignore
mvPieSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvPlot.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvPlotAxis.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot,)  # type: ignore
mvPlotLegend.__item_parents__ = (mvStage, mvTemplateRegistry, mvPlot, mvSubPlots,)  # type: ignore
mvProgressBar.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvRadioButton.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvRawTexture.__item_parents__ = (mvStage, mvTemplateRegistry, mvTextureRegistry,)  # type: ignore
mvResizeHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvScatterSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvScrollHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvSelectable.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSeparator.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSeriesValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvShadeSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvSimplePlot.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSlider3D.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderDouble.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderDoubleMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderFloat.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderFloatMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderInt.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSliderIntMulti.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSpacer.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvStairSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvStaticTexture.__item_parents__ = (mvStage, mvTemplateRegistry, mvTextureRegistry,)  # type: ignore
mvStemSeries.__item_parents__ = (mvPlotAxis, mvTemplateRegistry,)  # type: ignore
mvStringValue.__item_parents__ = (mvValueRegistry,)  # type: ignore
mvSubPlots.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvSyncedTables.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvTab.__item_parents__ = (mvTabBar, mvStage, mvTemplateRegistry,)  # type: ignore
mvTabBar.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvTabButton.__item_parents__ = (mvTabBar, mvStage, mvTemplateRegistry,)  # type: ignore
mvTable.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvTableCell.__item_parents__ = (mvStage, mvTemplateRegistry, mvTableRow,)  # type: ignore
mvTableColumn.__item_parents__ = (mvStage, mvTemplateRegistry, mvTable,)  # type: ignore
mvTableRow.__item_parents__ = (mvStage, mvTemplateRegistry, mvTable,)  # type: ignore
mvText.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvThemeColor.__item_parents__ = (mvThemeComponent, mvTemplateRegistry,)  # type: ignore
mvThemeComponent.__item_parents__ = (mvTheme, mvTemplateRegistry,)  # type: ignore
mvThemeStyle.__item_parents__ = (mvThemeComponent, mvTemplateRegistry,)  # type: ignore
mvTimePicker.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvToggledOpenHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
mvTooltip.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvTreeNode.__item_parents__ = _COMMON_PARENTS  # type: ignore
mvVisibleHandler.__item_parents__ = (mvStage, mvTemplateRegistry, mvItemHandlerRegistry,)  # type: ignore
del _COMMON_PARENTS
...
mvChildWindow.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvClipper.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvCollapsingHeader.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvColorMapRegistry.__item_children__ = (mvColorMap,)  # type: ignore
mvCustomSeries.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvDragPayload.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvDrawLayer.__item_children__ = (mvDrawLine, mvDrawArrow, mvDrawTriangle, mvDrawCircle, mvDrawEllipse, mvDrawBezierCubic, mvDrawBezierQuadratic, mvDrawQuad, mvDrawRect, mvDrawText, mvDrawPolygon, mvDrawPolyline, mvDrawImage, mvDrawImageQuad, mvDrawNode,)  # type: ignore
mvDrawNode.__item_children__ = (mvDrawLine, mvDrawArrow, mvDrawTriangle, mvDrawCircle, mvDrawEllipse, mvDrawBezierCubic, mvDrawBezierQuadratic, mvDrawQuad, mvDrawRect, mvDrawText, mvDrawPolygon, mvDrawPolyline, mvDrawImage, mvDrawImageQuad, mvDrawNode,)  # type: ignore
mvDrawlist.__item_children__ = (mvDrawLayer, mvDrawLine, mvDrawArrow, mvDrawTriangle, mvDrawCircle, mvDrawEllipse, mvDrawBezierCubic, mvDrawBezierQuadratic, mvDrawQuad, mvDrawRect, mvDrawText, mvDrawPolygon, mvDrawPolyline, mvDrawImageQuad, mvDrawImage, mvDrawNode,)  # type: ignore
mvFileDialog.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvFilterSet.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvFont.__item_children__ = (mvFontChars, mvFontRange, mvCharRemap, mvFontRangeHint, mvTemplateRegistry,)  # type: ignore
mvFontRegistry.__item_children__ = (mvFont,)  # type: ignore
mvGroup.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvHandlerRegistry.__item_children__ = (mvKeyDownHandler, mvKeyPressHandler, mvKeyReleaseHandler, mvMouseMoveHandler, mvMouseWheelHandler, mvMouseClickHandler, mvMouseDoubleClickHandler, mvMouseDownHandler, mvMouseReleaseHandler, mvMouseDragHandler,)  # type: ignore
mvItemHandlerRegistry.__item_children__ = (mvActivatedHandler, mvActiveHandler, mvClickedHandler, mvDoubleClickedHandler, mvDeactivatedAfterEditHandler, mvDeactivatedHandler, mvEditedHandler, mvFocusHandler, mvHoverHandler, mvResizeHandler, mvToggledOpenHandler, mvVisibleHandler, mvScrollHandler,)  # type: ignore
mvMenu.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvMenuBar.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvNode.__item_children__ = (mvNodeAttribute, mvActiveHandler, mvClickedHandler, mvDoubleClickedHandler, mvHoverHandler, mvVisibleHandler, mvDragPayload,)  # type: ignore
mvNodeAttribute.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvNodeEditor.__item_children__ = (mvMenuBar, mvNode, mvNodeLink, mvActivatedHandler, mvActiveHandler, mvClickedHandler, mvDoubleClickedHandler, mvDeactivatedAfterEditHandler, mvDeactivatedHandler, mvEditedHandler, mvFocusHandler, mvHoverHandler, mvResizeHandler, mvToggledOpenHandler, mvVisibleHandler,)  # type: ignore
mvPlot.__item_children__ = (mvPlotLegend, mvPlotAxis, mvDragPoint, mvDragRect, mvDragLine, mvAnnotation, mvDrawLine, mvDrawArrow, mvDrawTriangle, mvDrawCircle, mvDrawEllipse, mvDrawBezierCubic, mvDrawBezierQuadratic, mvDrawQuad, mvDrawRect, mvDrawText, mvDrawPolygon, mvDrawPolyline, mvDrawImage, mvDrawLayer, mvActivatedHandler, mvActiveHandler, mvClickedHandler, mvDoubleClickedHandler, mvDeactivatedAfterEditHandler, mvDeactivatedHandler, mvEditedHandler, mvFocusHandler, mvHoverHandler, mvResizeHandler, mvToggledOpenHandler, mvVisibleHandler, mvDragPayload, mvDrawNode,)  # type: ignore
mvPlotAxis.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvPlotLegend.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvStage.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvSubPlots.__item_children__ = (mvPlot, mvPlotLegend,)  # type: ignore
mvSyncedTables.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTab.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTabBar.__item_children__ = (mvTab, mvTabButton, mvActivatedHandler, mvActiveHandler, mvClickedHandler, mvDoubleClickedHandler, mvDeactivatedAfterEditHandler, mvDeactivatedHandler, mvEditedHandler, mvFocusHandler, mvHoverHandler, mvResizeHandler, mvToggledOpenHandler, mvVisibleHandler,)  # type: ignore
mvTable.__item_children__ = (mvTooltip, mvTableRow, mvTableColumn,)  # type: ignore
mvTableCell.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTableRow.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTemplateRegistry.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTextureRegistry.__item_children__ = (mvStaticTexture, mvDynamicTexture, mvRawTexture,)  # type: ignore
mvTheme.__item_children__ = (mvThemeComponent,)  # type: ignore
mvThemeComponent.__item_children__ = (mvThemeColor, mvThemeStyle,)  # type: ignore
mvTooltip.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvTreeNode.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvValueRegistry.__item_children__ = (mvBoolValue, mvIntValue, mvInt4Value, mvFloatValue, mvFloat4Value, mvStringValue, mvDoubleValue, mvDouble4Value, mvColorValue, mvFloatVectValue, mvSeriesValue,)  # type: ignore
mvViewportDrawlist.__item_children__ = (mvDrawLayer, mvDrawLine, mvDrawArrow, mvDrawTriangle, mvDrawCircle, mvDrawEllipse, mvDrawBezierCubic, mvDrawBezierQuadratic, mvDrawQuad, mvDrawRect, mvDrawText, mvDrawPolygon, mvDrawPolyline, mvDrawImageQuad, mvDrawImage, mvDrawNode,)  # type: ignore
mvViewportMenuBar.__item_children__ = _COMMON_CHILDREN  # type: ignore
mvWindowAppItem.__item_children__ = _COMMON_CHILDREN  # type: ignore
