...
class mvFont(ContainerItem, ChildItem, command="add_font", slot=1):
    ...
    pixel_snapV = _property__pixel_snapV
...
class mvInputDouble(ChildItem, command="add_input_double", slot=1):
    ...
    accept_empty_input = _property__accept_empty_input
    width = _property__width
    indent = _property__indent
    source = _property__source
    callback = _property__callback
...
class mvInputText(ChildItem, command="add_input_text", slot=1):
    ...
    elide_left = _property__elide_left
    width = _property__width
    height = _property__height
    indent = _property__indent
    source = _property__source
...
class mvSelectable(ChildItem, command="add_selectable", slot=1):
    ...
    select_on_nav = _property__select_on_nav
    width = _property__width
    height = _property__height
    indent = _property__indent
    source = _property__source
...
class mvTab(ContainerItem, ChildItem, command="add_tab", slot=1):
    ...
    no_close_with_middle_click = _property__no_close_with_middle_click
...
class mvTabBar(ContainerItem, ChildItem, command="add_tab_bar", slot=1):
    ...
    no_close_with_middle_click = _property__no_close_with_middle_click
    no_scrolling_buttons = _property__no_scrolling_buttons
    no_tooltip = _property__no_tooltip
    draw_selected_overline = _property__draw_selected_overline
    indent = _property__indent
    callback = _property__callback
    show = _property__show
    filter_key = _property__filter_key
...
class mvTreeNode(ContainerItem, ChildItem, command="add_tree_node", slot=1):
    ...
    catch_nav_left = _property__catch_nav_left
    lines = _property__lines
    indent = _property__indent
    show = _property__show
    filter_key = _property__filter_key
    drop_callback = _property__drop_callback
...
class mvWindowAppItem(ContainerItem, command="add_window", slot=1):
    ...
    no_scroll_with_mouse = _property__no_scroll_with_mouse
    no_docking = _property__no_docking
    copy_contents_shortcut = _property__copy_contents_shortcut
...
mvFont.__item_children__ = (mvCharRemap, mvTemplateRegistry,)  # type: ignore
