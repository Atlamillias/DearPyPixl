...
from dearpypixl.itemtypes.item import _ItemTypeMeta
from dearpypixl.itemtypes import ItemProperty, Item, ItemType, InternalType



class AppItemMeta(_ItemTypeMeta):
...
class AppItem(ItemType, metaclass=AppItemMeta):
    @abstractmethod
    def tag()           -> int | str     : ...
    @abstractmethod
