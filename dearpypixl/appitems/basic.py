...
class RadioButton(Widget):
    ...
    items                    : Union[List[str], Tuple[str, ...]] = ItemAttribute("configuration", "get_item_configuration", "configure_item", "items")             
...
class Listbox(Widget):
    ...
    track_offset             : float                             = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")      
    default_value            : str                               = ItemAttribute('information', 'get_unmanagable', None, 'default_value')                          
    num_items                : int                               = ItemAttribute("configuration", "get_item_configuration", "configure_item", "num_items")         
    value                    : str                               = ItemAttribute("configuration", "get_value", "set_value", "default_value")                       
...
class Button(Widget):
    ...
    tracked             : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "tracked")                                                                                                                                                                        
    track_offset        : float                             = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")                                                                                                                                                                   
    small               : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "small")                                                                                                                                                                          
    arrow               : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "arrow")                                                                                                                                                                          
    direction           : int                               = ItemAttribute("configuration", "get_item_configuration", "configure_item", "direction")                                                                                                                                                                      
...
class Selectable(Widget):
    ...
    track_offset             : float                             = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")      
    default_value            : bool                              = ItemAttribute('information', 'get_unmanagable', None, 'default_value')                          
    span_columns             : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "span_columns")      
    value                    : bool                              = ItemAttribute("configuration", "get_value", "set_value", "default_value")                       
...
class Combo(Widget):
    ...
    track_offset             : float                             = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")                 
    default_value            : str                               = ItemAttribute('information', 'get_unmanagable', None, 'default_value')                                     
    popup_align_left         : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "popup_align_left")             
    no_arrow_button          : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "no_arrow_button")              
    no_preview               : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "no_preview")                   
    height_mode              : int                               = ItemAttribute("configuration", "get_item_configuration", "configure_item", "height_mode")                  
    value                    : str                               = ItemAttribute("configuration", "get_value", "set_value", "default_value")                                  
...
class InputText(Widget):
    ...
    decimal                  : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "decimal")           
    hexadecimal              : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "hexadecimal")       
    readonly                 : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "readonly")          
    password                 : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "password")          
    scientific               : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "scientific")        
    on_enter                 : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "on_enter")          
    value                    : str                               = ItemAttribute("configuration", "get_value", "set_value", "default_value")                       
...
class SliderFloat(Widget):
    ...
    no_input                 : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "no_input")          
...
class Text(Widget):
    ...
    tracked             : bool                              = ItemAttribute("configuration", "get_item_configuration", "configure_item", "tracked")           
    track_offset        : float                             = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")      
    wrap                : int                               = ItemAttribute("configuration", "get_item_configuration", "configure_item", "wrap")              
...
class TabButton(Widget):
    ...
    leading           : bool     = ItemAttribute("configuration", "get_item_configuration", "configure_item", "leading")           
    trailing          : bool     = ItemAttribute("configuration", "get_item_configuration", "configure_item", "trailing")          
...
class MenuItem(Widget):
    ...
    track_offset      : float    = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")      
    default_value     : bool     = ItemAttribute('information', 'get_unmanagable', None, 'default_value')                          
    shortcut          : str      = ItemAttribute("configuration", "get_item_configuration", "configure_item", "shortcut")          
    check             : bool     = ItemAttribute("configuration", "get_item_configuration", "configure_item", "check")             
    value             : bool     = ItemAttribute("configuration", "get_value", "set_value", "default_value")                       
...
class Image(Widget):
    ...
    tracked             : bool                                  = ItemAttribute("configuration", "get_item_configuration", "configure_item", "tracked")           
    track_offset        : float                                 = ItemAttribute("configuration", "get_item_configuration", "configure_item", "track_offset")      
    tint_color          : Union[List[float], Tuple[float, ...]] = ItemAttribute("configuration", "get_item_configuration", "configure_item", "tint_color")        
    border_color        : Union[List[float], Tuple[float, ...]] = ItemAttribute("configuration", "get_item_configuration", "configure_item", "border_color")      
