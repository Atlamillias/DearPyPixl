...
class Grid:
    ...
    @overload
    def push(self, item: ItemId, row: int, col: int, /, *, max_width: int = ..., max_height: int = ..., anchor: str = ..., normalize_indexes: bool = ...) -> None: ...
    @overload
    def push(self, item: ItemId, r1: int, c1: int, r2: int, c2: int, /, *, max_width: int = ..., max_height: int = ..., anchor: str = ..., normalize_indexes: bool = ...) -> None: ...
