...
class mv2dHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., **kwargs) -> None: ...
...
class mvAnnotation(PlottingType, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: Any = ..., offset: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., clamped: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., default_value: Any = ..., offset: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., clamped: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., clamped: bool = ..., **kwargs) -> None: ...
...
class mvAreaSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
...
class mvBarSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., weight: float = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvButton(SupportsSized, SupportsCallback, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., small: bool = ..., arrow: bool = ..., direction: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., small: bool = ..., arrow: bool = ..., direction: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'small', 'arrow', 'direction'], Any]: ...
...
class mvCandleSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def __init__(self, dates: Sequence[float], opens: Sequence[float], closes: Sequence[float], lows: Sequence[float], highs: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int, int | None] | list[int] = ..., bear_color: tuple[int, int, int, int | None] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(dates: Sequence[float], opens: Sequence[float], closes: Sequence[float], lows: Sequence[float], highs: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int, int | None] | list[int] = ..., bear_color: tuple[int, int, int, int | None] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int, int | None] | list[int] = ..., bear_color: tuple[int, int, int, int | None] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> None: ...
...
class mvCheckbox(SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset'], Any]: ...
...
class mvChildWindow(SupportsSized, WindowType, ContainerType, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., border: bool = ..., autosize_x: bool = ..., autosize_y: bool = ..., no_scrollbar: bool = ..., horizontal_scrollbar: bool = ..., menubar: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., border: bool = ..., autosize_x: bool = ..., autosize_y: bool = ..., no_scrollbar: bool = ..., horizontal_scrollbar: bool = ..., menubar: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'border', 'autosize_x', 'autosize_y', 'no_scrollbar', 'horizontal_scrollbar', 'menubar'], Any]: ...
...
class mvClipper(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., before: 'Item' = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> None: ...
...
class mvCollapsingHeader(ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'closable', 'open_on_double_click', 'open_on_arrow', 'leaf', 'bullet'], Any]: ...
...
class mvColorButton(SupportsSized, SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., no_alpha: bool = ..., no_border: bool = ..., no_drag_drop: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'no_alpha', 'no_border', 'no_drag_drop'], Any]: ...
...
class mvColorMap(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    show: Property[bool] = ...
    def __init__(self, colors: tuple[int, int, int, int | None] | list[int], qualitative: bool, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @staticmethod
    def command(colors: tuple[int, int, int, int | None] | list[int], qualitative: bool, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
...
class mvColorMapButton(SupportsSized, SupportsCallback, BasicType):
    ...
    def command(default_value: tuple[int, int, int, int | None] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset'], Any]: ...
...
class mvColorMapScale(SupportsSized, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'drop_callback', 'show', 'colormap', 'min_scale', 'max_scale'], Any]: ...
...
class mvColorMapSlider(SupportsSized, SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset'], Any]: ...
...
class mvCombo(SupportsCallback, BasicType):
    ...
    @staticmethod
    def command(items: Sequence[str] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: str = ..., popup_align_left: bool = ..., no_arrow_button: bool = ..., no_preview: bool = ..., height_mode: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., popup_align_left: bool = ..., no_arrow_button: bool = ..., no_preview: bool = ..., height_mode: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'popup_align_left', 'no_arrow_button', 'no_preview', 'height_mode'], Any]: ...
...
class mvCustomSeries(SupportsValueArray, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    y3: Property[Any] = ...
    tooltip: Property[bool] = ...
    def __init__(self, x: Sequence[float], y: Sequence[float], channel_count: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], channel_count: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., **kwargs) -> None: ...
...
class mvDatePicker(SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., level: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'level'], Any]: ...
...
class mvDragDouble(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'format', 'speed', 'min_value', 'max_value', 'no_input', 'clamped'], Any]: ...
...
class mvDragDoubleMulti(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'size', 'format', 'speed', 'min_value', 'max_value', 'no_input', 'clamped'], Any]: ...
...
class mvDragLine(SupportsCallback, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> None: ...
...
class mvDragPoint(SupportsCallback, BasicType):
    ...
    thickness: Property[float] = ...
    show_label: Property[bool] = ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> None: ...
...
class mvDrawArrow(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    size: Property[int] = ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> None: ...
...
class mvDrawBezierCubic(DrawingType, BasicType):
    ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawBezierQuadratic(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    segments: Property[int] = ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'show', 'color', 'thickness', 'segments'], Any]: ...
...
class mvDrawCircle(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    segments: Property[int] = ...
    def __init__(self, center: Sequence[float], radius: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(center: Sequence[float], radius: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawEllipse(DrawingType, BasicType):
    ...
    thickness: Property[float] = ...
    segments: Property[int] = ...
    def __init__(self, pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'show', 'color', 'fill', 'thickness', 'segments'], Any]: ...
...
class mvDrawImage(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    def __init__(self, texture_tag: 'Item', pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawImageQuad(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    def __init__(self, texture_tag: 'Item', p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawLayer(DrawingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., perspective_divide: bool = ..., depth_clipping: bool = ..., cull_mode: int = ..., **kwargs) -> None: ...
...
class mvDrawLine(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    thickness: Property[float] = ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawNode(DrawNodeType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvDrawPolygon(DrawingType, BasicType):
    ...
    fill: Property[tuple[int, int, int, int | None] | list[int]] = ...
    thickness: Property[float] = ...
    def __init__(self, points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawPolyline(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    thickness: Property[float] = ...
    def __init__(self, points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(points: Sequence[Sequence[float]], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawQuad(DrawingType, BasicType):
    ...
    fill: Property[tuple[int, int, int, int | None] | list[int]] = ...
    thickness: Property[float] = ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'show', 'color', 'fill', 'thickness'], Any]: ...
...
class mvDrawText(DrawingType, BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    size: Property[float] = ...
    def __init__(self, pos: tuple[int, int] | list[int], text: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., size: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(pos: tuple[int, int] | list[int], text: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., size: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., size: float = ..., **kwargs) -> None: ...
...
class mvDrawTriangle(DrawingType, BasicType):
    ...
    fill: Property[tuple[int, int, int, int | None] | list[int]] = ...
    thickness: Property[float] = ...
    def __init__(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'show', 'color', 'fill', 'thickness'], Any]: ...
...
class mvDrawlist(SupportsSized, SupportsCallback, DrawingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset'], Any]: ...
...
class mvErrorSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., contribute_to_bounds: bool = ..., horizontal: bool = ..., **kwargs) -> None: ...
...
class mvFileExtension(BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    def __init__(self, extension: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., custom_text: str = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(extension: str, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., parent: 'Item' = ..., before: 'Item' = ..., custom_text: str = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., before: 'Item' = ..., custom_text: str = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvFont(FontType, ContainerType, BasicType):
    ...
    user_data: Property[Any] = ...
    use_internal_label: Property[bool] = ...
    def __init__(self, file: str, size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @staticmethod
    def command(file: str, size: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label'], Any]: ...
...
class mvGroup(SupportsSized, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'horizontal', 'horizontal_spacing', 'xoffset'], Any]: ...
...
class mvHLineSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    def __init__(self, x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvHeatSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    format: Property[str] = ...
    contribute_to_bounds: Property[bool] = ...
    def __init__(self, x: Sequence[float], rows: int, cols: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], rows: int, cols: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
...
class mvHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    outliers: Property[bool] = ...
    contribute_to_bounds: Property[bool] = ...
    def __init__(self, x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumlative: bool = ..., density: bool = ..., outliers: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumlative: bool = ..., density: bool = ..., outliers: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumlative: bool = ..., density: bool = ..., outliers: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
...
class mvImage(SupportsSized, BasicType):
    ...
    uv_min: Property[Sequence[float]] = ...
    uv_max: Property[Sequence[float]] = ...
    def __init__(self, texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., border_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., border_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., border_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'tint_color', 'border_color', 'uv_min', 'uv_max'], Any]: ...
...
class mvImageButton(SupportsSized, SupportsCallback, BasicType):
    ...
    uv_min: Property[Sequence[float]] = ...
    uv_max: Property[Sequence[float]] = ...
    def __init__(self, texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., frame_padding: int = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., background_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., frame_padding: int = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., background_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., frame_padding: int = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., background_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'frame_padding', 'tint_color', 'background_color', 'uv_min', 'uv_max'], Any]: ...
...
class mvImageSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    uv_max: Property[Sequence[float]] = ...
    tint_color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    def __init__(self, texture_tag: 'Item', bounds_min: Sequence[float], bounds_max: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(texture_tag: 'Item', bounds_min: Sequence[float], bounds_max: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvInputDouble(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'format', 'min_value', 'max_value', 'step', 'step_fast', 'min_clamped', 'max_clamped', 'on_enter', 'readonly'], Any]: ...
...
class mvInputDoubleMulti(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'format', 'min_value', 'max_value', 'size', 'min_clamped', 'max_clamped', 'on_enter', 'readonly'], Any]: ...
...
class mvInputInt(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'min_value', 'max_value', 'step', 'step_fast', 'min_clamped', 'max_clamped', 'on_enter', 'readonly'], Any]: ...
...
class mvInputIntMulti(SupportsCallback, BasicType):
    ...
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: tuple[int, int, int, int | None] | list[int] = ..., min_value: int = ..., max_value: int = ..., size: int = ..., min_clamped: bool = ..., max_clamped: bool = ..., on_enter: bool = ..., readonly: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., min_value: int = ..., max_value: int = ..., size: int = ..., min_clamped: bool = ..., max_clamped: bool = ..., on_enter: bool = ..., readonly: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'min_value', 'max_value', 'size', 'min_clamped', 'max_clamped', 'on_enter', 'readonly'], Any]: ...
...
class mvInt4Value(BasicType):
    ...
    use_internal_label: Property[bool] = ...
    source: Property['Item'] = ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: tuple[int, int, int, int | None] | list[int] = ..., parent: 'Item' = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., source: 'Item' = ..., default_value: tuple[int, int, int, int | None] | list[int] = ..., parent: 'Item' = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source'], Any]: ...
...
class mvKnobFloat(SupportsSized, SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'min_value', 'max_value'], Any]: ...
...
class mvLabelSeries(PlottingType, BasicType):
    ...
    vertical: Property[bool] = ...
    def __init__(self, x: float, y: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., x_offset: int = ..., y_offset: int = ..., vertical: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: float, y: float, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., x_offset: int = ..., y_offset: int = ..., vertical: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., x_offset: int = ..., y_offset: int = ..., vertical: bool = ..., **kwargs) -> None: ...
...
class mvListbox(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'num_items'], Any]: ...
...
class mvLoadingIndicator(SupportsSized, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int, int | None] | list[int] = ..., secondary_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int, int | None] | list[int] = ..., secondary_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., style: int = ..., circle_count: int = ..., speed: float = ..., radius: float = ..., thickness: float = ..., color: tuple[int, int, int, int | None] | list[int] = ..., secondary_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'drop_callback', 'show', 'style', 'circle_count', 'speed', 'radius', 'thickness', 'color', 'secondary_color'], Any]: ...
...
class mvMenu(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
...
class mvMenuBar(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., show: bool = ..., delay_search: bool = ..., **kwargs) -> None: ...
...
class mvMenuItem(SupportsCallback, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., default_value: bool = ..., shortcut: str = ..., check: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., shortcut: str = ..., check: bool = ..., **kwargs) -> None: ...
...
class mvNode(NodeType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., draggable: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'draggable'], Any]: ...
...
class mvNodeAttribute(NodeType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., attribute_type: int = ..., shape: int = ..., category: str = ..., **kwargs) -> None: ...
...
class mvNodeEditor(SupportsCallback, NodeEditorType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., delink_callback: Callable | None = ..., menubar: bool = ..., minimap: bool = ..., minimap_location: int = ..., **kwargs) -> None: ...
...
class mvPieSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def __init__(self, x: float, y: float, radius: float, values: Sequence[float], labels: Sequence[str], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: float, y: float, radius: float, values: Sequence[float], labels: Sequence[str], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., **kwargs) -> None: ...
...
class mvPlot(SupportsSized, SupportsCallback, PlotType, ContainerType, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., no_title: bool = ..., no_menus: bool = ..., no_box_select: bool = ..., no_mouse_pos: bool = ..., no_highlight: bool = ..., no_child: bool = ..., query: bool = ..., crosshairs: bool = ..., anti_aliased: bool = ..., equal_aspects: bool = ..., use_local_time: bool = ..., use_ISO8601: bool = ..., use_24hour_clock: bool = ..., pan_button: int = ..., pan_mod: int = ..., fit_button: int = ..., context_menu_button: int = ..., box_select_button: int = ..., box_select_mod: int = ..., box_select_cancel_button: int = ..., query_button: int = ..., query_mod: int = ..., query_toggle_mod: int = ..., horizontal_mod: int = ..., vertical_mod: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., no_title: bool = ..., no_menus: bool = ..., no_box_select: bool = ..., no_mouse_pos: bool = ..., no_highlight: bool = ..., no_child: bool = ..., query: bool = ..., crosshairs: bool = ..., anti_aliased: bool = ..., equal_aspects: bool = ..., use_local_time: bool = ..., use_ISO8601: bool = ..., use_24hour_clock: bool = ..., pan_button: int = ..., pan_mod: int = ..., fit_button: int = ..., context_menu_button: int = ..., box_select_button: int = ..., box_select_mod: int = ..., box_select_cancel_button: int = ..., query_button: int = ..., query_mod: int = ..., query_toggle_mod: int = ..., horizontal_mod: int = ..., vertical_mod: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'no_title', 'no_menus', 'no_box_select', 'no_mouse_pos', 'no_highlight', 'no_child', 'query', 'crosshairs', 'anti_aliased', 'equal_aspects', 'use_local_time', 'use_ISO8601', 'use_24hour_clock', 'pan_button', 'pan_mod', 'fit_button', 'context_menu_button', 'box_select_button', 'box_select_mod', 'box_select_cancel_button', 'query_button', 'query_mod', 'query_toggle_mod', 'horizontal_mod', 'vertical_mod'], Any]: ...
...
class mvPlotAxis(PlotAxisType, ContainerType, BasicType):
    ...
    time: Property[bool] = ...
    def __init__(self, axis: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., log_scale: bool = ..., invert: bool = ..., lock_min: bool = ..., lock_max: bool = ..., time: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(axis: int, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., log_scale: bool = ..., invert: bool = ..., lock_min: bool = ..., lock_max: bool = ..., time: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., no_gridlines: bool = ..., no_tick_marks: bool = ..., no_tick_labels: bool = ..., log_scale: bool = ..., invert: bool = ..., lock_min: bool = ..., lock_max: bool = ..., time: bool = ..., **kwargs) -> None: ...
...
class mvPlotLegend(PlottingType, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., outside: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., outside: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., location: int = ..., horizontal: bool = ..., outside: bool = ..., **kwargs) -> None: ...
...
class mvProgressBar(SupportsSized, BasicType):
    ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., overlay: str = ..., default_value: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., overlay: str = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'overlay'], Any]: ...
...
class mvRadioButton(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'horizontal'], Any]: ...
...
class mvSelectable(SupportsSized, SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'span_columns', 'disable_popup_close'], Any]: ...
...
class mvSeparator(BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'show'], Any]: ...
...
class mvShadeSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., y2: Any = ..., **kwargs) -> None: ...
...
class mvSlider3D(SupportsSized, SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., max_x: float = ..., max_y: float = ..., max_z: float = ..., min_x: float = ..., min_y: float = ..., min_z: float = ..., scale: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'max_x', 'max_y', 'max_z', 'min_x', 'min_y', 'min_z', 'scale'], Any]: ...
...
class mvSliderDouble(SupportsSized, SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'vertical', 'no_input', 'clamped', 'min_value', 'max_value', 'format'], Any]: ...
...
class mvSliderDoubleMulti(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'size', 'no_input', 'clamped', 'min_value', 'max_value', 'format'], Any]: ...
...
class mvSpacer(SupportsSized, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'show'], Any]: ...
...
class mvStemSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    source: Property['Item'] = ...
    show: Property[bool] = ...
    def __init__(self, x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(x: Sequence[float], y: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
...
class mvSubPlots(SupportsSized, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., row_ratios: Sequence[float] = ..., column_ratios: Sequence[float] = ..., no_title: bool = ..., no_menus: bool = ..., no_resize: bool = ..., no_align: bool = ..., link_rows: bool = ..., link_columns: bool = ..., link_all_x: bool = ..., link_all_y: bool = ..., column_major: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'row_ratios', 'column_ratios', 'no_title', 'no_menus', 'no_resize', 'no_align', 'link_rows', 'link_columns', 'link_all_x', 'link_all_y', 'column_major'], Any]: ...
...
class mvTab(ContainerType, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: bool = ..., **kwargs) -> None: ...
...
class mvTabBar(SupportsCallback, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., reorderable: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'reorderable'], Any]: ...
...
class mvTableCell(TableType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., height: int = ..., before: 'Item' = ..., show: bool = ..., filter_key: str = ..., **kwargs) -> None: ...
...
class mvText(BasicType):
    ...
    color: Property[tuple[int, int, int, int | None] | list[int]] = ...
    show_label: Property[bool] = ...
    def __init__(self, default_value: str = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., show_label: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(default_value: str = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., show_label: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., source: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., wrap: int = ..., bullet: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., show_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'source', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'wrap', 'bullet', 'color', 'show_label'], Any]: ...
...
class mvThemeColor(SupportsValueArray, ThemeElementType, BasicType):
    ...
    user_data: Property[Any] = ...
    use_internal_label: Property[bool] = ...
    def __init__(self, target: int = ..., value: tuple[int, int, int, int | None] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> None: ...
    @staticmethod
    def command(target: int = ..., value: tuple[int, int, int, int | None] | list[int] = ..., *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., category: int = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., **kwargs) -> None: ...
...
class mvThemeComponent(ThemeElementType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., enabled_state: bool = ..., **kwargs) -> None: ...
...
class mvTimePicker(SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., hour24: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'hour24'], Any]: ...
...
class mvTooltip(ContainerType, BasicType):
    ...
    use_internal_label: Property[bool] = ...
    show: Property[bool] = ...
    def __init__(self, parent: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(parent: 'Item', *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., show: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show'], Any]: ...
...
class mvTreeNode(ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'delay_search', 'tracked', 'track_offset', 'open_on_double_click', 'open_on_arrow', 'leaf', 'bullet', 'selectable'], Any]: ...
...
class mvViewportDrawlist(DrawingType, RootType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., filter_key: str = ..., delay_search: bool = ..., front: bool = ..., **kwargs) -> None: ...
...
class mvWindowAppItem(SupportsSized, WindowType, RootType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., on_close: Callable | None = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'show', 'delay_search', 'min_size', 'max_size', 'menubar', 'collapsed', 'autosize', 'no_resize', 'no_title_bar', 'no_move', 'no_scrollbar', 'no_collapse', 'horizontal_scrollbar', 'no_focus_on_appearing', 'no_bring_to_front_on_focus', 'no_close', 'no_background', 'modal', 'popup', 'no_saved_settings', 'no_open_over_existing_popup', 'on_close'], Any]: ...
