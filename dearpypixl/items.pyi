...
class mv2dHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., xbins: int = ..., ybins: int = ..., xmin_range: float = ..., xmax_range: float = ..., ymin_range: float = ..., ymax_range: float = ..., density: bool = ..., outliers: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'xbins', 'ybins', 'xmin_range', 'xmax_range', 'ymin_range', 'ymax_range', 'density', 'outliers'], Any]: ...
...
class mvAnnotation(PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., offset: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., clamped: bool = ..., **kwargs) -> None: ...
...
class mvAreaSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
...
class mvButton(SupportsSized, SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'small', 'arrow', 'direction'], Any]: ...
...
class mvCandleSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., bull_color: tuple[int, int, int, int | None] | list[int] = ..., bear_color: tuple[int, int, int, int | None] | list[int] = ..., weight: float = ..., tooltip: bool = ..., time_unit: int = ..., **kwargs) -> None: ...
...
class mvChildWindow(SupportsSized, WindowType, ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'payload_type', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'border', 'autosize_x', 'autosize_y', 'no_scrollbar', 'horizontal_scrollbar', 'menubar', 'no_scroll_with_mouse'], Any]: ...
...
class mvColorMapScale(SupportsSized, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., colormap: 'Item' = ..., min_scale: float = ..., max_scale: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'source', 'payload_type', 'drop_callback', 'show', 'colormap', 'min_scale', 'max_scale'], Any]: ...
...
class mvCombo(SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'popup_align_left', 'no_arrow_button', 'no_preview', 'height_mode'], Any]: ...
...
class mvCustomSeries(SupportsValueArray, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., y1: Any = ..., y2: Any = ..., y3: Any = ..., tooltip: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'callback', 'show', 'y1', 'y2', 'y3', 'tooltip'], Any]: ...
...
class mvDragLine(SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'callback', 'show', 'color', 'thickness', 'show_label', 'vertical'], Any]: ...
...
class mvDragPoint(SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'callback', 'show', 'color', 'thickness', 'show_label'], Any]: ...
...
class mvDrawArrow(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., size: int = ..., **kwargs) -> None: ...
...
class mvDrawBezierCubic(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawCircle(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., segments: int = ..., **kwargs) -> None: ...
...
class mvDrawImage(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawImageQuad(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., uv1: Sequence[float] = ..., uv2: Sequence[float] = ..., uv3: Sequence[float] = ..., uv4: Sequence[float] = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvDrawLine(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawPolygon(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawPolyline(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., closed: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., thickness: float = ..., **kwargs) -> None: ...
...
class mvDrawRect(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., color_upper_left: tuple[int, int, int, int | None] | list[int] = ..., color_upper_right: tuple[int, int, int, int | None] | list[int] = ..., color_bottom_right: tuple[int, int, int, int | None] | list[int] = ..., color_bottom_left: tuple[int, int, int, int | None] | list[int] = ..., fill: tuple[int, int, int, int | None] | list[int] = ..., multicolor: tuple[int, int, int, int | None] | list[int] = ..., rounding: float = ..., thickness: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'show', 'color', 'color_upper_left', 'color_upper_right', 'color_bottom_right', 'color_bottom_left', 'fill', 'multicolor', 'rounding', 'thickness'], Any]: ...
...
class mvDrawText(DrawingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int, int | None] | list[int] = ..., size: float = ..., **kwargs) -> None: ...
...
class mvFileExtension(BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., custom_text: str = ..., color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvGroup(SupportsSized, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'horizontal', 'horizontal_spacing', 'xoffset'], Any]: ...
...
class mvHeatSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., scale_min: float = ..., scale_max: float = ..., bounds_min: Any = ..., bounds_max: Any = ..., format: str = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'scale_min', 'scale_max', 'bounds_min', 'bounds_max', 'format', 'contribute_to_bounds'], Any]: ...
...
class mvHistogramSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., bins: int = ..., bar_scale: float = ..., min_range: float = ..., max_range: float = ..., cumlative: bool = ..., density: bool = ..., outliers: bool = ..., contribute_to_bounds: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'bins', 'bar_scale', 'min_range', 'max_range', 'cumlative', 'density', 'outliers', 'contribute_to_bounds'], Any]: ...
...
class mvImageButton(SupportsSized, SupportsCallback, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., source: 'Item' = ..., payload_type: str = ..., callback: Callable | None = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., frame_padding: int = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., background_color: tuple[int, int, int, int | None] | list[int] = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'frame_padding', 'tint_color', 'background_color', 'uv_min', 'uv_max'], Any]: ...
...
class mvImageSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., uv_min: Sequence[float] = ..., uv_max: Sequence[float] = ..., tint_color: tuple[int, int, int, int | None] | list[int] = ..., **kwargs) -> None: ...
...
class mvInputText(SupportsSized, SupportsCallback, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'source', 'payload_type', 'callback', 'drag_callback', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset', 'hint', 'multiline', 'no_spaces', 'uppercase', 'tab_input', 'decimal', 'hexadecimal', 'readonly', 'password', 'scientific', 'on_enter'], Any]: ...
...
class mvLabelSeries(PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., x_offset: int = ..., y_offset: int = ..., vertical: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'x_offset', 'y_offset', 'vertical'], Any]: ...
...
class mvPieSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., show: bool = ..., format: str = ..., angle: float = ..., normalize: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'source', 'show', 'format', 'angle', 'normalize'], Any]: ...
...
class mvStemSeries(SupportsValueArray, PlottingType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., source: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'source', 'show'], Any]: ...
...
class mvSubPlots(SupportsSized, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'callback', 'show', 'filter_key', 'tracked', 'track_offset', 'row_ratios', 'column_ratios', 'no_title', 'no_menus', 'no_resize', 'no_align', 'link_rows', 'link_columns', 'link_all_x', 'link_all_y', 'column_major'], Any]: ...
...
class mvTab(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: bool = ..., **kwargs) -> None: ...
...
class mvTreeNode(ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'open_on_double_click', 'open_on_arrow', 'leaf', 'bullet', 'selectable'], Any]: ...
