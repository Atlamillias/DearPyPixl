...
class mvChildWindow(SupportsSized, WindowType, ContainerType, BasicType):
    ...
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., parent: 'Item' = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., delay_search: bool = ..., tracked: bool = ..., track_offset: float = ..., border: bool = ..., autosize_x: bool = ..., autosize_y: bool = ..., no_scrollbar: bool = ..., horizontal_scrollbar: bool = ..., menubar: bool = ..., no_scroll_with_mouse: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., border: bool = ..., autosize_x: bool = ..., autosize_y: bool = ..., no_scrollbar: bool = ..., horizontal_scrollbar: bool = ..., menubar: bool = ..., no_scroll_with_mouse: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'border', 'autosize_x', 'autosize_y', 'no_scrollbar', 'horizontal_scrollbar', 'menubar', 'no_scroll_with_mouse'], Any]: ...
...
class mvClipper(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., indent: int = ..., before: 'Item' = ..., show: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'indent', 'before', 'show'], Any]: ...
...
class mvCollapsingHeader(ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'closable', 'open_on_double_click', 'open_on_arrow', 'leaf', 'bullet'], Any]: ...
...
class mvDrawlist(SupportsSized, SupportsCallback, DrawingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'callback', 'show', 'filter_key', 'tracked', 'track_offset'], Any]: ...
...
class mvGroup(SupportsSized, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., horizontal: bool = ..., horizontal_spacing: float = ..., xoffset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'horizontal', 'horizontal_spacing', 'xoffset'], Any]: ...
...
class mvMenu(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., enabled: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drop_callback', 'show', 'enabled', 'filter_key', 'tracked', 'track_offset'], Any]: ...
...
class mvNode(NodeType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., before: 'Item' = ..., payload_type: str = ..., drag_callback: Callable | None = ..., drop_callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., draggable: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'draggable'], Any]: ...
...
class mvNodeEditor(SupportsCallback, NodeEditorType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., delink_callback: Callable | None = ..., menubar: bool = ..., minimap: bool = ..., minimap_location: int = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'before', 'callback', 'show', 'filter_key', 'tracked', 'track_offset', 'delink_callback', 'menubar', 'minimap', 'minimap_location'], Any]: ...
...
class mvSubPlots(SupportsSized, SupportsCallback, PlottingType, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., row_ratios: Sequence[float] = ..., column_ratios: Sequence[float] = ..., no_title: bool = ..., no_menus: bool = ..., no_resize: bool = ..., no_align: bool = ..., link_rows: bool = ..., link_columns: bool = ..., link_all_x: bool = ..., link_all_y: bool = ..., column_major: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'before', 'callback', 'show', 'filter_key', 'tracked', 'track_offset', 'row_ratios', 'column_ratios', 'no_title', 'no_menus', 'no_resize', 'no_align', 'link_rows', 'link_columns', 'link_all_x', 'link_all_y', 'column_major'], Any]: ...
...
class mvTab(ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., payload_type: str = ..., drop_callback: Callable | None = ..., show: bool = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., closable: bool = ..., no_tooltip: bool = ..., order_mode: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'closable', 'no_tooltip', 'order_mode'], Any]: ...
...
class mvTabBar(SupportsCallback, ContainerType, BasicType):
    ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., indent: int = ..., before: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., filter_key: str = ..., tracked: bool = ..., track_offset: float = ..., reorderable: bool = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'callback', 'show', 'filter_key', 'tracked', 'track_offset', 'reorderable'], Any]: ...
...
class mvTreeNode(ContainerType, BasicType):
    ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'indent', 'before', 'payload_type', 'drag_callback', 'drop_callback', 'show', 'filter_key', 'tracked', 'track_offset', 'open_on_double_click', 'open_on_arrow', 'leaf', 'bullet', 'selectable'], Any]: ...
...
class mvWindowAppItem(SupportsSized, WindowType, RootType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., delay_search: bool = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., width: int = ..., height: int = ..., indent: int = ..., show: bool = ..., pos: tuple[int, int] | list[int] = ..., min_size: Sequence[int] = ..., max_size: Sequence[int] = ..., menubar: bool = ..., collapsed: bool = ..., autosize: bool = ..., no_resize: bool = ..., no_title_bar: bool = ..., no_move: bool = ..., no_scrollbar: bool = ..., no_collapse: bool = ..., horizontal_scrollbar: bool = ..., no_focus_on_appearing: bool = ..., no_bring_to_front_on_focus: bool = ..., no_close: bool = ..., no_background: bool = ..., modal: bool = ..., popup: bool = ..., no_saved_settings: bool = ..., no_open_over_existing_popup: bool = ..., no_scroll_with_mouse: bool = ..., on_close: Callable | None = ..., **kwargs) -> None: ...
    def configuration(self) -> dict[Literal['label', 'user_data', 'use_internal_label', 'width', 'height', 'indent', 'show', 'min_size', 'max_size', 'menubar', 'collapsed', 'autosize', 'no_resize', 'no_title_bar', 'no_move', 'no_scrollbar', 'no_collapse', 'horizontal_scrollbar', 'no_focus_on_appearing', 'no_bring_to_front_on_focus', 'no_close', 'no_background', 'modal', 'popup', 'no_saved_settings', 'no_open_over_existing_popup', 'no_scroll_with_mouse', 'on_close'], Any]: ...
