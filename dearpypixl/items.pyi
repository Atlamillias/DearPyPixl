...
class mvDragLine(SupportsCallback, BasicType):
    ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., vertical: bool = ..., **kwargs) -> None: ...
...
class mvDragPoint(SupportsCallback, BasicType):
    ...
    thickness: Property[float] = ...
    show_label: Property[bool] = ...
    def __init__(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> None: ...
    @staticmethod
    def command(*, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., default_value: Any = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., source: 'Item' = ..., callback: Callable | None = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., thickness: float = ..., show_label: bool = ..., **kwargs) -> None: ...
...
class mvDrawRect(DrawingType, BasicType):
    ...
    show: Property[bool] = ...
    color: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    color_upper_left: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    color_upper_right: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    color_bottom_right: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    color_bottom_left: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    fill: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    multicolor: Property[tuple[int, int, int] | tuple[int, int, int, int] | list[int]] = ...
    rounding: Property[float] = ...
    thickness: Property[float] = ...
    def __init__(self, pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., **kwargs) -> None: ...
    @staticmethod
    def command(pmin: Sequence[float], pmax: Sequence[float], *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., tag: 'Item' = ..., parent: 'Item' = ..., before: 'Item' = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., **kwargs) -> Item: ...
    def configure(self, *, label: str | None = ..., user_data: Any = ..., use_internal_label: bool = ..., show: bool = ..., color: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_upper_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_right: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., color_bottom_left: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., fill: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., multicolor: tuple[int, int, int] | tuple[int, int, int, int] | list[int] = ..., rounding: float = ..., thickness: float = ..., **kwargs) -> None: ...
