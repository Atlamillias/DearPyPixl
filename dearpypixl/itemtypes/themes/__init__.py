...
from typing import Callable, Sequence, Any, Optional, TypeAlias
...
# Type aliases
Numeric               : TypeAlias = int | float | decimal.Decimal
...
class Theme(Item):
    ...
    def font(self) -> Font | None:
        ...
        return self.__font
    @font.setter
    def font(self, value: str | Font | None):
...
class ThemeComponent(Item):
    item_type    : int | ItemIndex = ItemProperty(CONFIG, None, None)
    ...
    def __init__(
        self,
        item_type         : int | ItemIndex = ItemIndex.ALL,
        label             : str             = None         ,
        user_data         : Any             = None         ,
        use_internal_label: bool            = True         ,
        parent            : int | str       = 0            ,
    ...
    def __manage_target_param(method: Callable = None):
        ...
        def wrapper(self, target: str | ThemeElement, *value: Numeric):
    ...
    def add_element(self, target: ThemeElement | str, *value: Numeric) -> int:
    ...
    @__manage_target_param
    def get_element_tag(self, target:ThemeElement | str) -> int:
