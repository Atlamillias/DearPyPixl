...
# of each registry. This was decided for several reasons which
# would be too lengthy to explain via code comments.

# All handlers are injected into HandlerRegistry subclasses at runtime
# as methods using the template below. This is to avoid re-typing
# almost the same code repeatedly and to dynamically add handlers
# that aren't "hard-coded" already. This could have been done using
# metaclasses and descriptors but I wanted the code itself to be
# readable.
...
# Probably because the parenting widget itself is the stand-in.
