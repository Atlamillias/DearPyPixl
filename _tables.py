...
class Table(Table):
    ...
    #### List-ish methods ####
    ##########################
    def index(self, row_col_cell_item: TableRow | TableColumn | TableCell) -> list[int] | int:
        ...
        Args:
            * row_col_cell_item (TableRow | TableColumn | TableCell): The item
    ...
    def highlight_cell(self, row_idx: int, column_idx: int, color: tuple[int, ...] | list[int]) -> None:
        dearpygui.highlight_table_cell(self._tag, row_idx, column_idx, color)

    def highlight_column(self, column_idx: int, color: tuple[int, ...] | list[int]) -> None:
        dearpygui.highlight_table_column(self._tag, column_idx, color)

    def highlight_row(self, row_idx: int, color: tuple[int, ...] | list[int]) -> None:
...
class TableRow(TableRow):
    ...
    def _get_index_params(method):
        def wrapper(self, color: tuple[int, ...] | list[int] = None, **kwargs) -> None:
    ...
    @_get_index_params
    def highlight(self, color: tuple[int, ...] | list[int], **kwargs) -> None:
        """Highlight this specific table row.

        Args:
            * color (tuple[int, ...] | list[int]): color of the highlight as
...
class TableColumn(TableColumn):
    ...
    @_get_index_params
    def highlight(self, color: tuple[int, ...] | list[int] = None, **kwargs) -> None:
